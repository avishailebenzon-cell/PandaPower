...
AI_DISCLOSURE = {
    # Female voice
    "tal": "🤖 אני טל, נציגה דיגיטלית מבוססת בינה מלאכותית (AI) של פנדה-טק.",
    "pandi": "🤖 אני ליבי, נציגה דיגיטלית מבוססת בינה מלאכותית (AI) של פנדה-טק.",
    # Male voice
    "elad": "🤖 אני אלעד, נציג דיגיטלי מבוסס בינה מלאכותית (AI) של פנדה-טק.",
    "pandius": "🤖 אני פנדיוס, נציג דיגיטלי מבוסס בינה מלאכותית (AI) של פנדה-טק.",
}
