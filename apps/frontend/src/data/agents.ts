...
export const RECRUITMENT_AGENTS: Record<string, Agent> = {
  ...
  mani: {
    ...
    description: "סוכן on-demand להתאמת מועמדים ללקוחות בהתאם לתחום וסיווג ביטחוני",
    specialization: ["Matching", "Client Relations", "Candidate Analysis", "Domain Matching", "Security Clearance"],
    experience: "סוכן מתקדם",
