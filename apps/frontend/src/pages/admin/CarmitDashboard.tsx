...
export const CarmitDashboard: React.FC = () => {
  ...
  const renderMatchCard = (match: Match) => {
    ...
    return (
      <div
        key={match.id}
        className="bg-gray-800 border border-gray-700 rounded-lg p-4 mb-4 hover:border-gray-600 transition"
      >
        {/* Header */}
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Tab Navigation */}
        <div className="mb-6 border-b border-gray-700 flex gap-2 flex-wrap">
          {[
