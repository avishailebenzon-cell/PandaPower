 ...
 * Display potential clients synced from Pipedrive
 */
...
import {
  ...
  PotentialClientResponse,
} from '@/api/pipedrive-data';

export function PotentialClientsPage() {
  ...
  return (
    <div className="p-8 bg-gray-900 min-h-screen" dir="rtl">
      ...
      <div className="space-y-2 mb-8">
        <h1 className="text-3xl font-bold text-white">לקוחות פוטנציאלים</h1>
        <p className="text-gray-400">
          רשימת כל הלקוחות הפוטנציאלים המסונכרים מ-Pipedrive
        </p>
      </div>
      ...
      <PipedriveDataTable
        ...
        isLoading={isLoading}
        searchPlaceholder="חיפוש לפי שם חברה או דוא״ל..."
        onSearch={setSearch}
        onSort={(key, order) => {
          setSortBy(key);
          setSortOrder(order);
