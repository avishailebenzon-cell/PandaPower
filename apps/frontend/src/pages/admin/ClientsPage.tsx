/**
 * Clients Page
 * Display all clients synced from Pipedrive
 */
...
import { fetchClients, ClientResponse } from '@/api/pipedrive-data';
...
export function ClientsPage() {
  ...
  const { data, isLoading, error } = useQuery({
    ...
    queryFn: () =>
      fetchClients(page, limit, search || undefined, status || undefined, sortBy, sortOrder),
    staleTime: 5 * 60 * 1000,
  });
    ...
    <div className="p-8 bg-gray-900 min-h-screen" dir="rtl">
      ...
      <div className="space-y-2 mb-8">
        ...
        <p className="text-gray-400">
          רשימת כל הלקוחות המסונכרים מ-Pipedrive
        </p>
      </div>
